...
regular).
     ...
     * @param {bool} [oi=false] is a bool flag to get open interest for futures and options instruments. Defaults to false.
     */
    ...
    function parseHistorical(jsonData, headers) {
        ...
        for(var i=0; i<jsonData.data.candles.length; i++) {
            ...
            // add oi field only if we have received oi in response
            if (d[6] !== undefined) {
                candle.oi = d[6];
            }
